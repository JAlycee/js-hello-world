...
console.log(hoursInWeek - leisureHours > hoursInWeek);
// give user feedback
console.log("Gotcha. You want to spend at least " + dailyGaming + " hours a day playing Baldur's Gate. That comes out to " + leisureHours + " hours spent across seven daily gaming sessions.\n");
